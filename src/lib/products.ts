...
export const bundle = {
  ...
  subtitle: "All 6 Packs + Bonus AI Skills Guide + Notion Templates",
  price: 9.99,
  originalPrice: 5.94,
  variantId: "",
  description:
    "Get all 6 AI Prompt Packs plus an exclusive AI Skills Guide and ready-to-use Notion templates. Install the complete framework library into your AI — from funnel architecture to copywriting, traffic to launches. Includes bonus resources not available in individual packs.",
};
